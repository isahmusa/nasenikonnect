  ...
  return (
    <>
      ...
      <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4">
        <DropdownMenu>
          <DropdownMenuTrigger asChild>
            <Button className="w-full sm:w-auto bg-gradient-to-r from-blue-500 to-indigo-600 text-white hover:bg-indigo-700 shadow-md rounded-lg py-3 flex items-center justify-center transition-transform hover:scale-105">
          ...
          <DropdownMenuContent className="w-56 p-2 bg-white shadow-lg rounded-lg border border-gray-200">
            <DropdownMenuItem
              ...
              className="text-sm text-gray-700 hover:bg-gray-100 rounded-md flex items-center space-x-2 py-2">
              <Link2 className='w-4 h-4 text-gray-500' />
              <span>Schedule Meeting</span>
            </DropdownMenuItem>
            <DropdownMenuItem
              onClick={handleStartMeeting}
              className="text-sm text-white-700 hover:bg-gray-100 rounded-md flex items-center space-x-2 py-2">
        ...
        <div className="flex w-full sm:w-auto relative">
          ...
          <Input
            ...
            className="pl-8 rounded-r-none pr-10 border-2 border-gray-300 shadow-sm focus:border-indigo-600 transition-all duration-300 ease-in-out"
            value={meetingLink}
            onChange={(e) => setMeetingLink(e.target.value)}
          />
          <Button
            variant="secondary"
            className="rounded-l-none bg-gradient-to-r from-blue-400 to-indigo-500 hover:bg-indigo-600 text-white transition-all duration-300 ease-in-out"
      ...
      <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
        <DialogContent className="max-w-sm rounded-lg p-6 bg-white shadow-lg transform transition-all duration-500 ease-in-out">
          <DialogHeader>
            <DialogTitle className="text-3xl font-semibold text-red-900 animate-pulse">
